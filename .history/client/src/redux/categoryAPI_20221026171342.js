...
export const getAllCategoriesAPI = async (dispatch) => {
  try {
    const response = await axios.get(`http://localhost:5000/api/category/getAllAuthors`)
...
export const createCategoryAPI = async (authorForm, dispatch) => {
  try {
...
export const updateCategoryAPI = async (authorForm, authorId, dispatch) => {
  try {
