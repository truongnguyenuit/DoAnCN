...
import { getAllAuthorsAPI } from '../redux/authorAPI';
import { getAllCategoriesAPI } from '../redux/categoryAPI';
const DashboardPage = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-cyan-200 to-pink-200 mt-[80px] ml-[300px] flex items-center justify-center flex-col gap-[20px] h-full pt-[10px]">
