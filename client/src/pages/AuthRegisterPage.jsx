...
const AuthRegisterPage = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string().required("Password is equired").min(4, "Must be 4 character or more"),
      confirmPassword: Yup.string().required("ComfirmPassword is required").min(4, "Must be 4 character or more")
    }),
    onSubmit: async (values) => {
      ...
      try {
        const registerData = await registerUser(values, navigate)
  ...
  return (
    <div className='  mt-[80px] flex justify-center bg-gradient-to-r from-cyan-200 to-pink-200 h-[1000px]'>
      ...
      <div className="bg-gradient-to-r from-cyan-100 to-pink-100 w-[475px] flex flex-col items-center gap-0.5 drop-shadow-lg p-8 mt-10 ml-72 h-fit rounded-md">
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-1 w-full">
          ...
          <Row>
            <Col span={24}>
              <div className="w-full h-[1px] p-0 bg-gradient-to-r from-cyan-100 to-pink-100 relative ">
